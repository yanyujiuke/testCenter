...
namespace Dcat\Admin {
     ...
     * @property Grid\Column|Collection create_ip
     ...
     * @method Grid\Column|Collection create_ip(string $label = null)
     ...
     * @property Show\Field|Collection create_ip
     ...
     * @method Show\Field|Collection create_ip(string $label = null)
